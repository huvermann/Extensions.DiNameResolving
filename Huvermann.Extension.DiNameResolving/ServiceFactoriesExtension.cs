...
namespace Huvermann.Extension.DiNameResolving
{
    public static class ServiceFactoriesExtension
    {
        ...
        public static IServiceCollection AddSingletonByName<TService, TImplementation>(this IServiceCollection services, string interfaceKey)
          where TService : class
          where TImplementation : class, TService
        {
        ...
        public static IServiceCollection AddScopedByName<TService, TImplementation>(this IServiceCollection services, string interfaceKey)
         where TService : class
         where TImplementation : class, TService
        {
